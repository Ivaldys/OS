...
- **Сервер (server.cpp):**
  ...
  - Поддерживает подключение мониторов для отображения комплексной информации.
...
5. Читатели и писатели будут взаимодействовать с сервером, выполняя свои операции и выводя результаты. Монитор будет отображать все эти операции.
